  ...
  schema: [
    {
      ...
      required: false,
      description:
        "Optioneel. Kies een vergunning om de kaart aan een item te koppelen. Laat leeg om een keuzeveld te tonen.",
    },
    {
      name: "title",
      selector: { text: {} },
...
export const getCardConfigForm = (): {
